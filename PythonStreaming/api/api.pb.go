...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	0x83, 0x23, 0x08, 0xca, 0x33, 0xb2, 0xe1, 0x62, 0x01, 0xd9, 0x25, 0x64, 0xc2, 0xc5, 0x11, 0x9c,
	0x58, 0xe9, 0x91, 0x9a, 0x93, 0x93, 0x2f, 0x24, 0xa0, 0x07, 0x72, 0x10, 0x92, 0x13, 0xa4, 0x30,
	0x44, 0x94, 0x18, 0x34, 0x18, 0x0d, 0x18, 0x8d, 0x1c, 0xb9, 0xd8, 0x20, 0xd6, 0x0b, 0x99, 0x73,
	0x71, 0x43, 0x58, 0xce, 0x19, 0xa9, 0xc9, 0xd9, 0x42, 0x42, 0x60, 0x0d, 0x28, 0x4e, 0x93, 0xc2,
	0x22, 0xa6, 0xc4, 0x90, 0xc4, 0x06, 0xf6, 0xb8, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xd7, 0x03,
	0xb6, 0x5f, 0x05, 0x01, 0x00, 0x00,
}
...
type PingClient interface {
	SayHello(ctx context.Context, opts ...grpc.CallOption) (Ping_SayHelloClient, error)
}
...
func (c *pingClient) SayHello(ctx context.Context, opts ...grpc.CallOption) (Ping_SayHelloClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Ping_serviceDesc.Streams[0], "/api.Ping/SayHello", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *pingSayHelloClient) Send(m *PingMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *pingSayHelloClient) Recv() (*PingMessage, error) {
	m := new(PingMessage)
...
type PingServer interface {
	SayHello(Ping_SayHelloServer) error
}
...
func _Ping_SayHello_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(PingServer).SayHello(&pingSayHelloServer{stream})
}
...
func (x *pingSayHelloServer) Send(m *PingMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *pingSayHelloServer) Recv() (*PingMessage, error) {
	m := new(PingMessage)
